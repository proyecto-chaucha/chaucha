    ...
    : QWidget()
{
    ...
    QString copyrightText   = QString::fromUtf8(CopyrightCore(strprintf("\xc2\xA9 %u-%u ", 2009, COPYRIGHT_YEAR)).c_str()) + "\n" + QString::fromUtf8(CopyrightHolders(strprintf("\xc2\xA9 %u-%u ", 2017, COPYRIGHT_YEAR)).c_str());
